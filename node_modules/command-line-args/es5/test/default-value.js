...
runner.test('default value', function () {
  ...
  a.deepStrictEqual(cliArgs([{ name: 'two', multiple: true, defaultValue: ['two', 'zwei'] }], ['--two', 'duo']), { two: ['duo'] });
});
...
runner.test('default value: array as defaultOption', function () {
  var defs = [{ name: 'two', multiple: true, defaultValue: ['two', 'zwei'], defaultOption: true }];
  var argv = ['duo'];
  a.deepStrictEqual(cliArgs(defs, argv), { two: ['duo'] });
});

runner.test('default value: falsy default values', function () {
  var defs = [{ name: 'one', defaultValue: 0 }, { name: 'two', defaultValue: false }];
